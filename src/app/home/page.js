...
function home() {
  ...
  const lines = ['Future of Agri Trading', 'AI in Agri Trading', 'Amazon for Agriculture'];
  ...
  return (
    <div>
      <main className="bg-white w-[100%] h-[100%]">
       ...
       <div className={`my-10 lg:my-16 mx-auto  w-[80%] items-center rounded-xl ${styles.back}`}>
            <div className={`${styles.welcome}`}>
                      <div className={`${styles.wt} ml-0 md:leading-tight md:h-full`}>
                           Welcome to
                           <br/>
                           <span className={``}>
                                {lines.map((line, index) => (
                                  <div
                                    key={index}
                                    className={`${styles.agri} ${index === currentLineIndex ? 'visible' : 'hidden'}`}
                                  >
                                    {line}
                                  </div>
                                ))}
       ...
       <div className={`${styles.getd} w-[85%] lg:w-[90%] mx-auto flex justify-center`}><div> Get discovered<span className="mx-3 lg:mx-9">|</span>Use the power of AI for your products</div></div>

       <div className={`${styles.join1}  flex justify-center my-12`}><a href='https://main.d3orhinag3f2ix.amplifyapp.com/'><span className={`${styles.join} px-5 rounded-lg text-white cursor-pointer py-4`}>Join AgriJod Today</span></a></div>

       <div className={`${styles.one} mt-24 mb-8 flex justify-center`}>Discover the best</div>
        

       <div className={`w-[85%] md:w-[70%] m-auto pb-20 ${styles.Carousel}`}>
         <Carousel>
           {slides.map((s)=>(
       ...
       <div className={` w-[85%] lg:w-[70%] m-auto  ${styles.stats} mb-10`}>
          ...
          <div className={`${styles.statePhoto} flex items-center`}>
               <img src="/images/image4.png" className="p-3 md:p-5"/>
          </div>
       </div>

       <div className={`w-[85%]  md:w-[70%] m-auto ${styles.two} mb-10 mt-32`}>
       ...
       <div className={`${styles.three}  w-[90%]  lg:w-[70%] m-auto mb-10 rounded-xl text-white mt-24`}>
          <div className={`${styles.four} flex flex-col justify-center ml-3 md:ml-5 h-full gap-2 pt-4`}>
              <div className={`${styles.six}`}>Get in touch with us</div>
              <div className={`${styles.seven} `}>Our representative will get back soon</div>
              <div className={`${styles.eight} flex `}><span><img src="/images/image8.png" className="h-full pb-6 w-full object-cover" /></span><span className="flex items-center pl-2 lg:pl-4 pb-6">scan to get the app</span></div>
          </div>
          <div className={`${styles.five} overflow-hidden`}>
              <div className={`${styles.nine} pr-1 lg:pr-3 pt-2 pl-2 text-black`}>
                    <div className="flex flex-col justify-between pt-1 pb-1 md:pt-3 md:pb-3" >
              ...
              <div className={`${styles.ten}  flex justify-end mb-5 mr-4 `}>
                  <div className={`p-1 md:pt-2 md:px-2 ${styles.twelve}`}> Get a callback</div>
              </div>
          </div>
       </div>

       <div className={`mt-14 mb-5 w-[85%] lg:w-[70%] m-auto ${styles.partners}`}>Our Partners</div>
      
       <div className={`${styles.partners} flex gap-8 w-[85%] lg:w-[70%] m-auto mb-36`}>
